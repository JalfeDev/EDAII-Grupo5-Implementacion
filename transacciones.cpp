...
public:
    int dato;
    Color color;
    ColorNode *izquierda, *derecha, *padre;
...
private:
    ...
    void rotarIzquierda(ColorNode*& raiz, ColorNode*& x) {
        ColorNode* y = x->derecha;
    ...
    void rotarDerecha(ColorNode*& raiz, ColorNode*& y) {
        ColorNode* x = y->izquierda;
    ...
    void fixInsercion(ColorNode*& raiz, ColorNode*& nodo) {
        ColorNode* padre = nullptr;
        ColorNode* abuelo = nullptr;
        ...
        while (nodo != raiz && nodo->color == ROJO && nodo->padre->color == ROJO) {
            ...
            // Padre es hijo derecho del abuelo
                ...
                ColorNode* tio = abuelo->izquierda;
    ...
    void insertarNodo(ColorNode*& raiz, ColorNode*& nodo) {
        if (raiz == nullptr) {
            raiz = nodo;
...
public:
    ...
    void insertar(int valor) {
        ColorNode* nuevo = new ColorNode(valor);
